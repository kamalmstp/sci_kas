    ...
    <div class="card">
        ...
        <form wire:submit.prevent="store">
            <div class="form-group">
                ...
                <input wire:model="id_kas" id="id_kas" type="hidden">
                <select class="form-select" id="defaultSelect" wire:model="id_category" aria-label="Kode">
            ...
            <div class="form-group">
                ...
                <input class="form-control @error('pengeluaran') is-invalid @enderror" wire:model="pengeluaran" id="pengeluaran" type="text" placeholder="Pengeluaran">
                @error('pengeluaran')

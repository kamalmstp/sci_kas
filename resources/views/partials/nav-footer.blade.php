<div class="footer-nav position-relative">
    ...
    <li class="{{ request()->is('home') || request()->is('/') ? 'active' : '' }}"><a href="/" data-turbolinks="true">
    ...
    <li class="{{ request()->is('kas') || request()->is('kas/create') || request()->is('kas/edit')? 'active' : '' }}"><a href="{{route('admin.kas.index')}}">
    ...
    <li class="{{ request()->is('kaskeluar*') ? 'active' : '' }}"><a href="{{route('admin.kaskeluar.index')}}">
    ...
    <li class="{{ request()->is('nota*') ? 'active' : '' }}"><a href="{{route('admin.nota.index')}}">
    ...
    <li class="{{ request()->is('setting*') ? 'active' : '' }}"><a href="{{route('admin.setting.index')}}">
